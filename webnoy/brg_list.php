...
//SetOrder Method @9-828F292A
    function SetOrder($SorterName, $SorterDirection)
    {
        ...
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            ...
            "Sorter_kd_hrgbeli" => array("kd_hrgbeli", ""),
...
//Prepare Method @9-71314EEE
    function Prepare()
    {
        ...
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "kd_hrgbeli", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
		$this->wp->Criterion[4] = $this->wp->Operation(opContains, "satuan", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
...
//Open Method @9-6109A04B
    function Open()
    {
        ...
        "FROM tb_barang";
        $this->SQL = "SELECT kd_brg,nama_brg,kd_hrgbeli,hrg_jual_grosir,hrg_jual_retail,stok,satuan,format(hrg_beli,0) as hrg_belinya, format(hrg_jual_grosir,0) as hrg_jual_grosirnya,format(hrg_jual_retail,0) as hrg_jual_retailnya,format(stok,0) as stoknya \n\n" .
...
function setuang($str)
    ...
    function SetValues()
    {
        ...
        $this->kd_hrgbeli->SetDBValue($this->setuang($this->f("hrg_belinya")));
