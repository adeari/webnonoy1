...
//Open Method @2-5538DF5A
    function Open()
    {
        ...
        $this->CountSQL = "SELECT COUNT(*) FROM tb_barang";
         $this->SQL = "select kd_brg,nama_brg,satuan,hrg_beli,hrg_jual_grosir,hrg_jual_retail,format(hrg_beli,0) as hrg_belinya,stok,kd_hrgbeli,format(hrg_jual_retail,0) as hrg_jual_retailnya,format(hrg_jual_grosir,0) as hrg_jual_grosirnya,format(hrg_beli,0) as hrg_belinya,format(stok,0) as stoknya  FROM tb_barang {SQL_Where} {SQL_OrderBy}";
...
//SetValues Method @2-F11C59A9
    function SetValues()
    {
		...
		$this->hrg_beli->SetDBValue($this->setuang($this->f("hrg_belinya")));
