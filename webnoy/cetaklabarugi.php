...
//Open Method @9-6109A04B
    function Open()
    {
        ...
        $this->SQL = "SELECT c.tanggal,a.kd_brg,format(a.stok,0) as stok, a.kd_hrgbeli,format(a.hrg_beli,0) as hrg_belinya,format(a.hrg_jual,0) as hrg_jual,format(a.selisih,0) as selisih,selisih as selisihx,b.satuan,b.nama_brg  FROM tb_trxjual1 a join tb_barang b on a.kd_brg=b.kd_brg join tb_trxjual c on a.nota=c.nota {SQL_Where} {SQL_OrderBy}";
