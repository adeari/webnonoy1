...
//Open Method @9-6109A04B
    function Open()
    {
        ...
        $this->SQL = "SELECT kd_brg,format(stok,0) as stok, kd_hrgbeli,format(hrg_beli,0) as hrg_belinya,format(hrg_jual_grosir,0) as hrg_jual_grosir,format(hrg_jual_retail,0) as hrg_jual_retail,satuan,nama_brg  FROM tb_barang  {SQL_Where} {SQL_OrderBy}";
		$this->Order = "nama_brg";
		$this->barang="";
