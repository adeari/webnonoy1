...
$totalitasnya=0;
$this->nota->Show();
		$this->datadetail->open("select a.kd_brg,b.nama_brg,b.satuan,format(a.hrg_jual,0) as hrg_jual,format(a.stok,0) as stok,b.stok as stokmax, a.kd_hrgbeli,format(a.totaljual,0) as totaljual,totaljual as totaljualx from tb_trxjual1 a join tb_barang b on a.kd_brg=b.kd_brg where a.nota='".CCGetFromGet("nota", NULL)."'");
		$i=0;
