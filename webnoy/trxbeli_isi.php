...
if ($this->databarang->has_next_record())
{
	...
	$querynya="update tb_barang set hrg_beli=".intval($hrg_beliisi).",	kd_hrgbeli='a',stok=".$stokisi." where kd_brg='".CCGetRequestParam("kd_brg".$i, ccsPost, NULL)."'";
	$this->DataSource->aturdetail($querynya);
