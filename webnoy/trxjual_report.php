...
//Open Method @9-6109A04B
    function Open()
    {
        ...
        $this->SQL = "SELECT a.kd_brg,format(a.stok,0) as stok, a.kd_hrgbeli,format(a.hrg_beli,0) as hrg_belinya,
	format(a.hrg_jual,0) as hrg_jual,format(a.totaljual,0) as totaljual,b.satuan,b.nama_brg,a.totaljual as totaljualx  FROM tb_trxjual1 a join tb_barang b on a.kd_brg=b.kd_brg {SQL_Where} {SQL_OrderBy}";
