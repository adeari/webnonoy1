...
//Open Method @9-6109A04B
    function Open()
    {
        ...
        $this->SQL = "SELECT a.kd_brg,format(a.stok,0) as stok, a.kd_hrgbeli,format(a.hrg_beli,0) as hrg_belinya,format(a.hrg_jual_grosir,0) as hrg_jual_grosir,format(a.hrg_jual_retail,0) as hrg_jual_retail,format(a.totalbeli,0) as totalbeli,b.satuan,b.nama_brg,a.totalbeli as totalbelix  FROM tb_trxbeli1 a join tb_barang b on a.kd_brg=b.kd_brg {SQL_Where} {SQL_OrderBy}";
